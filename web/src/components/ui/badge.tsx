...
const badgeVariants = cva(
  'inline-flex items-center justify-center rounded-none border px-2 py-0.5 text-[10px] font-bold uppercase tracking-[0.15em] w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 transition-all',
  {
    variants: {
      variant: {
        default:
